...
export default function Contact() {
  ...
  const LocationCard = ({ location, title }) => (
    <div className="bg-ivory p-6 transition-colors duration-300 dark:bg-dark-card sm:p-8">
      <h3 className="text-xl font-bold text-charcoal dark:text-dark-text">{title}</h3>
      <div className="mt-6 grid gap-5">
        <a href={location.phoneHref} className="flex gap-4 text-charcoal hover:text-gold dark:text-dark-muted dark:hover:text-gold">
      ...
      <div className="mt-6">
        <h4 className="font-semibold text-charcoal dark:text-dark-text">Get Directions</h4>
        <div className="mt-3 grid gap-2 sm:grid-cols-2">
          <a href={location.directions} className="btn-primary px-4 py-3 text-xs" target="_blank" rel="noreferrer">
            Open Maps
          </a>
          <a href={location.phoneHref} className="btn-primary px-4 py-3 text-xs">
            Call Now
          </a>
        </div>
      </div>
      ...
      <div className="container-lux">
        <div className="mb-16">
          ...
          <p className="mt-4 text-lg text-charcoal/75 dark:text-dark-muted">
            Book a site visit or free interior consultation at our offices in Dimapur, Nagaland and Lahorijan, Assam.
          </p>
        </div>
        ...
        <div className="mb-16 grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <h3 className="mt-2 text-2xl font-bold text-charcoal dark:text-dark-text">Get a Free Consultation</h3>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-sm text-charcoal/60 dark:text-dark-muted/70">
              We provide premium interior design, false ceilings, PVC wall panels, WPC cladding, gypsum board solutions, and complete turnkey interior projects across Nagaland and Assam.
            </p>
          </div>
        </div>

        <div className="grid gap-10 lg:grid-cols-2">
          <LocationCard location={locations.nagaland} title="Dimapur, Nagaland" />
